    ...
    <div class="bottom-apoio">
        <div class="container">
            ...
            <div class="logo-apoio">
                <img src="<?= INCLUDE_PATH; ?>assets/img/logo_itaucultural.png" alt="Itaú Cultural" class="logo-apoio">
            </div>
        </div>
        <div class="container-secundario">
            <strong>Apoio Institucional</strong>
            <div class="logo-apoio">
		  	    <img src="<?= INCLUDE_PATH; ?>assets/img/galo_da_manha.png" alt="Galo da Manhã" class="logo-apoio">
		    </div>
            <div class="logo-apoio">
                <img src="<?= INCLUDE_PATH; ?>assets/img/ibirapitanga.png" alt="Ibirapitanga" class="logo-apoio">
            </div>
            <div class="logo-apoio">
                <img src="<?= INCLUDE_PATH; ?>assets/img/tide_setubal.png" alt="Fundação Tide Setubal" class="logo-apoio">
            </div>
        </div>
    </div>
	<div class="bottom">
        <div class="container">
            ...
            <div class="creative-commons">
                <a href="https://creativecommons.org/licenses/by-nc-nd/4.0/deed.pt_BR" target="_blank"><img src="<?= INCLUDE_PATH; ?>assets/img/creative_commons.png" alt="Galo da Manhã" class="logo-apoio"></a>
            </div>
